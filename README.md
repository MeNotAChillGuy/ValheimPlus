...
We supply 4 different versions of V+ with every  since version 0.8. You can find detailed instructions on how to install these variants below.
...
1.  the [latest package called WindowsClient.zip over this link](https://github.com/nxPublic/ValheimPlus//latest/). *(Scroll down and click "assets")*
...
1.  the [latest package called WindowsServer.zip over this link](https://github.com/valheimPlus/ValheimPlus//latest/). *(Scroll down and click "assets")*
...
1.  the [latest package called UnixServer.zip over this link](https://github.com/valheimPlus/ValheimPlus//latest/). *(Scroll down and click "assets")*
2. Extract the contents of the .zip file into your root server folder.
...
2.  the [latest package called UnixServer.zip over this link](https://github.com/valheimPlus/ValheimPlus//latest/). *(Scroll down and click "assets")*.
...
5. Complete the installation by backing up your game folder, extracting the package, and adding the necessary permissions:
  ...
  unzip -o ~//UnixServer.zip -d $my_path  
...
In case you encounter any issues, use Steam's verify integrity feature and wait for it to /update all files.
...
# Twitter
Is used to post about  of ValheimPlus and to potentially reply to issues.
